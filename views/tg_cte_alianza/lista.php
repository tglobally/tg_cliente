        ...
        <div class="lista">
            ...
            <table class="table ">
                            ...
                            <tr>
                                ...
                                <th data-breakpoints="xs sm md" data-type="html" >Tipo Alianza</th>
                ...
                <?php foreach ($controlador->registros as $registro){
                    ...
                    ?>
                    <tr>
                        <td><?php echo $registro->tg_cte_alianza_id; ?></td>
                        <td><?php echo $registro->tg_cte_alianza_codigo; ?></td>
                        <td><?php echo $registro->tg_cte_alianza_codigo_bis; ?></td>
                        <td><?php echo $registro->tg_cte_alianza_descripcion; ?></td>
                        <td><?php echo $registro->tg_cte_tipo_alianza_descripcion; ?></td>
