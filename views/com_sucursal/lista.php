...
<?php include 'templates/com_sucursal/lista/secciones.php'; ?>
            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro){
                    ...
                    <tr>
                        ...
                        <th><?php echo $registro->com_sucursal_id; ?></th>
                        <th><?php echo $registro->com_sucursal_codigo; ?></th>
                        <th><?php echo $registro->com_sucursal_codigo_bis; ?></th>
                        <th><?php echo $registro->com_sucursal_descripcion; ?></th>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
