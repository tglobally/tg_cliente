            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro){
                    ...
                    <tr>
                        ...
                        <th><?php echo $registro->com_producto_id; ?></th>
                        <th><?php echo $registro->com_producto_codigo; ?></th>
                        <th><?php echo $registro->com_producto_codigo_bis; ?></th>
                        <th><?php echo $registro->com_producto_descripcion; ?></th>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
