...
<div class="col-md-9 formulario">
    <div class="col-lg-12">
        ...
        <div class="  form-main" id="form">
            <form method="post" action="./index.php?seccion=tg_cte_tipo_alianza&accion=modifica_generales&session_id=<?php echo $controlador->session_id; ?>&registro_id=<?php echo $controlador->registro_id; ?>" class="form-additional">
