...
<?php include 'templates/com_cliente/asigna_alianza/secciones.php'; ?>
<div class="col-md-9 formulario">
    <div class="col-lg-12 row">
        ...
        <div class="  form-main" id="form">
            <form method="post" action="./index.php?seccion=com_cliente&accion=rel_cliente_alianza_bd&session_id=<?php echo $controlador->session_id; ?>&registro_id=<?php echo $controlador->registro_id; ?>" class="form-additional">
